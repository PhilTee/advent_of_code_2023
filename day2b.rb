...
@data.each do |game_id, iterations|
  max_cubes = Hash.new(0)
  iterations.each do |iteration|
    iteration.each do |colour, count|
      max_cubes[colour] = count if count > max_cubes[colour]
    end
  end

  max_cubes_per_game[game_id] = max_cubes
end

puts max_cubes_per_game

power = max_cubes_per_game.collect do |game_id, cubes|
  cubes.values.inject(:*)
end
